...
// ANSWER: 
The first function creates an array that depends on the length of the original parameter. This makes its complexity o(n) even though the object created is o(1) complexity.

The object of the second function can only be up to 26 key value pairs due to the regex replace function.
Since the for loop depends upon the parameter, it is not considered o(n) complexity.
